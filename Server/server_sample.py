...
def get_filtered_data():
    ...
    csv_file_path = r'...\DataSet\master_dataset_school.csv'
...
def get_suburb_data():
    csv_file_path = r'C:\Users\alexr\Downloads\Address.csv'
...
def get_filtered_crime_data():
    try:
        ...
        csv_file_path = '..\DataSet\SuburbData2022_Crime.csv'  # Adjust the path as needed
